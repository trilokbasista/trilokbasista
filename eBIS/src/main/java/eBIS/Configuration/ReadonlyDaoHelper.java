...
public class ReadonlyDaoHelper {
	
	@Autowired
	@PersistenceContext(unitName="readonlyPersistence")
	@Qualifier(value="readonlyEntityManager")	
	private EntityManager entityManager;
	
	public ReadonlyDaoHelper() {
	}

	public ReadonlyDaoHelper(final EntityManager entityManager) {
